...
class motor_command():
    def __init__(self):#初期化
        ...
        self.Enable = True
        self.pin_num_PWM = 16#pinの名前
        self.pin_num_RotationDirect = 20
        self.pin_num_Enable = 12
        self.pin_num_Stop = 21
        self.freq = 50 # Hz (PWM のパルスを一秒間に 50 個生成)
        #ノード立ち上げ（ROS）
        rospy.init_node('motor3_control')
        rospy.Subscriber('motor3/cmd_vel', Int64, self.callback)
