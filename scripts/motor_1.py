...
class motor_command():
    def __init__(self):#初期化
        ...
        #ノード立ち上げ（ROS）
        rospy.init_node('motor1_control')
        rospy.Subscriber('motor1/cmd_vel', Int64, self.callback)
        rospy.loginfo('Ready to receive motor1 command')
